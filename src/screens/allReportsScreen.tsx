...
import { getAllChapters, getAllLevels, getAllPrograms, getAllQuestions, setItemsAsync} from "../reducers/misSlice";
...
const AllReportsScreen: React.FC<UpdateProps>=({itm, mode, setMode}) =>{
