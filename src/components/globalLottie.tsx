...
const GlobalLottie: React.FC<ZipLottieBTNProps> = ({ loop, autoplay, data, name, isAudio, segments, audioData = data }) => {
    ...
    useEffect(() => {
        if (!zip) {
            getURL(`global/${data}.zip`);
            setURLs(`global/${audioData}`);
