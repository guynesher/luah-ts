...
const LocalLottie: React.FC<ZipLottieBTNProps> = ({ loop, autoplay, data, name, isAudio, segments, audioData = data }) => {
    ...
    useEffect(() => {
      ...
      useEffect(() => { 
        if(!mount) { 
          ...
          }, [dispatch,mount,name,loop,autoplay,data,buttons,segments]) 
